...
def static "com.ct.qa.keywords.CommonKeywords.visitPlanogramCloseButton"() {
    (new com.ct.qa.keywords.CommonKeywords()).visitPlanogramCloseButton()
}
...
def static "com.ct.qa.keywords.CommonKeywords.visitPrimaryShelfPlanogramImageViewButton"() {
    (new com.ct.qa.keywords.CommonKeywords()).visitPrimaryShelfPlanogramImageViewButton()
}
...
def static "com.ct.qa.keywords.SurveyKeywords.visitQuestionsWithYesRemark"() {
    (new com.ct.qa.keywords.SurveyKeywords()).visitQuestionsWithYesRemark()
}

def static "com.ct.qa.keywords.SurveyKeywords.visitQuestionsWithNoRemark"() {
    (new com.ct.qa.keywords.SurveyKeywords()).visitQuestionsWithNoRemark()
}
...
def static "com.ct.qa.keywords.BrandAvailability.validateBrands"() {
    (new com.ct.qa.keywords.BrandAvailability()).validateBrands()
}

def static "com.ct.qa.keywords.BrandAvailability.visitBrands"(
    	int flag	) {
    (new com.ct.qa.keywords.BrandAvailability()).visitBrands(
        	flag)
}

def static "com.ct.qa.keywords.TposmCategoryKeywords.validateBrands"() {
    (new com.ct.qa.keywords.TposmCategoryKeywords()).validateBrands()
}

def static "com.ct.qa.keywords.TposmCategoryKeywords.visitBrands"() {
    (new com.ct.qa.keywords.TposmCategoryKeywords()).visitBrands()
}

def static "com.ct.qa.keywords.SecondaryDisplayKeywords.visitSecondaryDisplayQuestions"() {
    (new com.ct.qa.keywords.SecondaryDisplayKeywords()).visitSecondaryDisplayQuestions()
}

def static "com.ct.qa.keywords.SecondaryDisplayKeywords.overwriteSecondaryDisplayQuestions"() {
    (new com.ct.qa.keywords.SecondaryDisplayKeywords()).overwriteSecondaryDisplayQuestions()
}
...
def static "com.ct.qa.keywords.Attendence_TposmKeywords.visitAttendance"() {
    (new com.ct.qa.keywords.Attendence_TposmKeywords()).visitAttendance()
}

def static "com.ct.qa.keywords.Attendence_TposmKeywords.validateBrands"() {
    (new com.ct.qa.keywords.Attendence_TposmKeywords()).validateBrands()
}

def static "com.ct.qa.keywords.Attendence_TposmKeywords.visitTposmCategories"() {
    (new com.ct.qa.keywords.Attendence_TposmKeywords()).visitTposmCategories()
}

def static "com.ct.qa.keywords.HotZoneKeywords.visitHotZoneQuestions"() {
    (new com.ct.qa.keywords.HotZoneKeywords()).visitHotZoneQuestions()
}

def static "com.ct.qa.keywords.HotZoneKeywords.overwriteHotZoneQuestions"() {
    (new com.ct.qa.keywords.HotZoneKeywords()).overwriteHotZoneQuestions()
}
