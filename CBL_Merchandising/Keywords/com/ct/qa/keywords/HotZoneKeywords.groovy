...
public class HotZoneKeywords {
	...
	def visitHotZoneQuestions(){
		...
		for(int i=1; i<= totalquestions; i++){
			...
			question.click()
			Mobile.verifyElementText(findTestObject("Object Repository/ShopOpen/HotZone/Validate_QuestionOptionsPopup", [('package') : ProjectConstants.PACKAGENAME]), questiontext)
			...
			Mobile.verifyElementText(findTestObject('ShopOpen/HotZone/Validate_HotZoneScreen', [('package') : ProjectConstants.PACKAGENAME]), 'Hot Zone')
