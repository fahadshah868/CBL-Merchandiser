...
Mobile.verifyElementText(findTestObject('ShopOpen/HotZone/Validate_HotZoneScreen', [('package') : ProjectConstants.PACKAGENAME]), 
    'Hot Zone')

CustomKeywords.'com.ct.qa.keywords.HotZoneKeywords.overwriteHotZoneQuestions'()
