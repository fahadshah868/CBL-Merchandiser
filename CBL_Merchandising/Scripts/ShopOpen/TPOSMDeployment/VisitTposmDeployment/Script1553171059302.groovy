...
CustomKeywords.'com.ct.qa.keywords.TposmCategoryKeywords.visitBrands'()

Mobile.tap(findTestObject('ShopOpen/TposmDeployment/FirstImage_Button', [('package') : ProjectConstants.PACKAGENAME]), 0)
