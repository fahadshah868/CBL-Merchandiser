...
MobileBuiltInKeywords.tap(findTestObject('ShopToBeMoved/ShopToBeMoved', [('package') : ProjectConstants.PACKAGENAME]), 0)

'validate confirm popup appearance'
MobileBuiltInKeywords.verifyElementExist(findTestObject('CommonScreenElements/Validate_InfoPopUP', [('package') : ProjectConstants.PACKAGENAME]), 
    0)

'tap on confirm pop up yes button'
MobileBuiltInKeywords.tap(findTestObject('CommonScreenElements/InfoPopUp_YesButton', [('package') : ProjectConstants.PACKAGENAME]), 
    0)
